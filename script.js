...
const calendarDate = document.querySelector(".date-year");
const calendar = document.querySelector(".calendar-month");
const popupAddTask = document.querySelector(".popup-back-add");
const closPopup = document.querySelector(".add-clos-icon");
const creatTask = document.querySelector(".add-popup-icon");
const taskInp = document.querySelector(".add-input");
const inpBox = document.querySelector(".add-inp-box");
const deletePopup = document.querySelector(".popup-back-remove");
const closPopupDel = document.querySelector(".btn-nie");
const deleteTask = document.querySelector(".btn-tak");
const spanDelete = document.querySelector(".span-task");
const d = new Date();
const day = d.getDate();
...
function load() {
    ...
    deleteTask.addEventListener("click", () => {
        let newArr = tasks.filter((task) => task.name !== taskName);
    ...
    tasks.forEach((task) => {
        document.querySelectorAll(".day-number").forEach((day) => {
            if (day.children[0].innerHTML === task.day &&
